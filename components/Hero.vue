...
<template>
  <section class="pt-16 lg:pt-36 min-h-screen overflow-hidden relative pb-0">
    <div class="container py-5 flex justify-center items-center relative z-10 mx-auto h-screen">
      <div class="grid w-full h-full lg:grid-cols-2">
        <ClientOnly>
          <div
            ...
            data-aos="fade-up"
          >
            <h1 class="tracking-wide text-info leading-tight font-monrepo text-5xl lg:text-[4rem] font-extrabold capitalize">
            ...
            <article class="prose text-sm md:text-xl w-3/4 text-accent font-medium">
              <p>
        ...
        <ClientOnly>
          <div class="flex items-start relative justify-center">
            <div class="w-full absolute h-full">
              <div class="bg-[#85FFF8] blur-3xl w-[418px] rounded-full h-[418px]"></div>

              <div class="bg-[#9785FF] opacity-75 top-0 absolute blur-3xl w-[629px] rounded-full h-[630px]"></div>
            </div>
