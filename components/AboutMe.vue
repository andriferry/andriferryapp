...
const imgArray = [
  ...
  orsoLogo,
  cazner,
  'https://framerusercontent.com/images/XdwtPSo8v1Lmo6KUZgfoWxA5rk.png',
]
...
<template>
  <Wrapper>
    <Container class="grid lg:grid-cols-2">
      <article
        id="latest-project"
        data-aos="fade-down"
      ...
      >
        ...
        <h3 class="text-info flex gap-3 items-center">
          My Skills
          <span class="icon-[twemoji--man-technologist] w-6 h-6"></span>
        </h3>
      ...
      >
        ...
        <div
          :class="widthCarousel"
          class="lg:w-full overflow-hidden"
        >
          <Flicking
            :options="options"
            :plugins="plugins"
