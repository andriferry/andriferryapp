                            ...
                            <div class="grid gap-5 z-10 lg:grid-cols-2 w-full">
                                <div
                                    ...
                                    <article
                                        class="prose text-center justify-center lg:text-start text-accent">
                                        <h1
                                            class="text-slate-500 mb-0 text-4xl lg:text-5xl">
                                            CosyPos
                                        </h1>
                            ...
                            <div class="grid gap-5 z-10 lg:grid-cols-2 w-full">
                                <div
                                    ...
                                    <article
                                        class="prose text-center justify-center lg:text-start text-accent">
                                        <h1
                                            class="text-white/80 mb-0 text-4xl lg:text-5xl">
                                            infitech
                                        </h1>
                                        ...
                                        <button
                                            class="btn btn-wide lg:w-auto bg-[#000D6B]/45 hover:bg-[#000D6B]/25 text-white border-none">
                                            See More
                                        </button>
                                    </article>
                                </div>
